...
int main(int argc, char** argv) {
    /* Create an instance */
    Vk::Instance instance{Vk::InstanceCreateInfo{argc, argv}.setApplicationInfo(
        "Magnum Vulkan Triangle Example"_s, {})};

    /* Create a device with a graphics queue */
    Vk::Queue queue{NoCreate};
    Vk::Device device{instance,
                      Vk::DeviceCreateInfo{Vk::pickDevice(instance)}.addQueues(
                          Vk::QueueFlag::Graphics, {0.0f}, {queue})};
    ...
    Vk::RenderPass renderPass{
        ...
        Vk::RenderPassCreateInfo{}
            .setAttachments({{VK_FORMAT_R8G8B8A8_SRGB,
                              Vk::AttachmentLoadOperation::Clear,
                              {}}})
            .addSubpass(Vk::SubpassDescription{}.setColorAttachments({0}))};
        ...
        Vk::MemoryFlag::HostVisible};
    {
        ...
        Containers::Array<char, Vk::MemoryMapDeleter> data =
            buffer.dedicatedMemory().map();
    ...
    Vk::Framebuffer framebuffer{
        device, Vk::FramebufferCreateInfo{renderPass, {color}, {800, 600}}};
...
; %2 = void fra()
    ...
    Vk::Shader shader{
        device,
        Vk::ShaderCreateInfo{CORRADE_INTERNAL_ASSERT_EXPRESSION(
    ...
    VkPipelineLayout pipelineLayout;
    {
        ...
        MAGNUM_VK_INTERNAL_ASSERT_SUCCESS(
    ...
    VkPipeline pipeline;
    {
        ...
        info.subpass = 0;
        MAGNUM_VK_INTERNAL_ASSERT_SUCCESS(vkCreateGraphicsPipelines(
    ...
    /* Begin a render pass */
    cmd.beginRenderPass(
        Vk::RenderPassBeginInfo{renderPass, framebuffer}.clearColor(
            0, 0x1f1f1f_srgbf));
    ...
    CORRADE_INTERNAL_ASSERT_EXPRESSION(
        ...
        ->exportToFile(ImageView2D{PixelFormat::RGBA8Unorm,
                                   {800, 600},
                                   image.dedicatedMemory().mapRead()},
                       "image.png");
